...
const SELF_GUARDED = ['/api/v2/agents', '/api/v2/api-tokens', '/api/v2/automations', '/api/v2/billing', '/api/v2/intake', '/api/v2/invoices', '/api/v2/webhooks', '/api/v2/instance', '/api/v2/timesheet-approval', '/api/v2/generate', '/api/v2/secrets'];
