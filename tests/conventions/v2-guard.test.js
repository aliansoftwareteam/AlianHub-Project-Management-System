...
const PUBLIC_BY_DESIGN = ['/api/v2/auth', '/api/v2/setup', '/api/v2/sso', '/api/v2/github-signup', '/api/v2/gitlab-signup', '/api/v2/google-signup', '/api/v2/logout', '/api/v2/session', '/api/v2/public-shares', '/api/v2/changelog', '/api/v2/csp-report', '/api/v2/sendForgotPasswordEmail', '/api/v2/scim',
