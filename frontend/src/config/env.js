...
module.exports.INVITATION_ACCEPT = '/api/v2/auth/invitation-accept';
...
module.exports.MAGIC_LINK = '/api/v2/auth/magic-link';
module.exports.SSO_DISCOVER = '/api/v2/sso/discover';
...
module.exports.AGENT_PIPELINE = '/api/v2/agents/pipeline';
module.exports.AGENT_RELEASE = '/api/v2/agents/release';
module.exports.AGENT_SETTINGS = '/api/v2/agents/settings';
...
module.exports.AI_SWITCH = '/api/v2/ai-switch';
...
module.exports.WORKFLOW_STEP_TYPES = '/api/v2/workflows/step-types';
module.exports.WORKFLOW_DEFINITIONS = '/api/v2/workflows/definitions';
...
module.exports.AGILE_PROVENANCE = '/api/v1/agile/provenance';
...
module.exports.AUTOMATIONS_V2 = '/api/v2/automations';
...
module.exports.TIMESHEET_WEEK = '/api/v1/timesheet/week';
...
module.exports.INSTANCE_AUDIT = '/api/v2/instance/audit';
