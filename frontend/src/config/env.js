...
module.exports.PROPOSAL_REVIEW = "/api/v1/proposal-review";
module.exports.PROPOSAL_REVIEW_STOP = "/api/v1/proposal-review/stop";
module.exports.PROPOSAL_REVIEW_EVENTS = "/api/v1/proposal-review-progress";
