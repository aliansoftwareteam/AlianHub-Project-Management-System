...
const tabs = computed(() => [
    { key: 'mine', label: 'TimeV2.tab_mine', route: 'User Timesheet', show: allowed('sheet_settings.user_timesheet') },
    { key: 'project', label: 'TimeV2.tab_project', route: 'project Timesheet', show: allowed('sheet_settings.project_timesheet') },
    { key: 'workload', label: 'TimeV2.tab_workload', route: 'Workload Timesheet', show: allowed('sheet_settings.workload_timesheet') },
    { key: 'tracker', label: 'TimeV2.tab_tracker', route: 'Tracker Timesheet', show: allowed('sheet_settings.tracker_timesheet') },
