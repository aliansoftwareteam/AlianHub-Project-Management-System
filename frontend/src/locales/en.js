export default {
    ...
    Integrations: {
        ...
        cloud_redirect_hint: "Paste this exact value into the provider's console as an authorised redirect URI. It differs per environment, so add the staging and production ones too.",
        cloud_ready: "Ready",
        ...
        cloud_admin_only: "Only an owner or admin can add or change these credentials.",
