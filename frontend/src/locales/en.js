export default {
    ...
    AI: {
        ...
        stop_review: "Stop",
        stopping_review: "Stopping review…",
        stopped: "stopped",
        starting: "Starting…",
        review_started: "Review started — checking proposals…",
        no_tasks_to_review: "No tasks in \"In Review - TL\" to review in this sprint.",
        skipped: "Skipped",
        skip_no_token: "no Upwork link",
        skip_no_proposal: "no proposal comment",
        skip_job_not_found: "job not in database",
        skip_no_proposal_in_thread: "no proposal in comments",
        skip_error: "error",
