export default {
    ...
    Integrations: {
        ...
        cloud_desc: "Optional. Attach files straight from Google Drive or Dropbox instead of uploading them. Register an app with the provider once, then each person connects their own account — everyone has their own drive. Nobody has to: uploading from your computer works exactly as before.",
        ...
        cloud_saved: "{provider} credentials saved",
        cloud_removed: "{provider} removed",
        cloud_confirm_remove: "Remove the {provider} credentials? This clears them for everyone and disconnects every account currently linked to {provider}.",
