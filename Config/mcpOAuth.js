...
const { SCOPES, READ_SCOPES, MODE, mode, isOn, issuer, resource } = oauthConfig;
...
module.exports = { SCOPES, READ_SCOPES, WRITE_SCOPES, MODE, mode, isOn, issuer, resource, resourceMetadataUrl };
