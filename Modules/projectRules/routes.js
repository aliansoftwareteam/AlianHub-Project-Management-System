...
const { READ, requireProjectAccess, SECURITY_SETTINGS } = require('../../Config/projectAccess');

exports.init = (app) => {
    app.get('/api/v1/projectRules/:pid', requireProjectAccess({ mode: READ, projectIds: (req) => req.params.pid }), ctrl.getProjectRules);
