...
/* A context with no run is a person's request (the apply endpoint): the worker did
 * not decide to make it. */
const workerIdentity = (context) => (context.runId ? serviceStamp('worker', 'serviceId') : {});
