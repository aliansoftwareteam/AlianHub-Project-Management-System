...
### 2026-09-10 — closed
- Done. P1–P8 shipped in 44f976ef, e6374317 and 9afe3d9e (PR #410). The wizard half (P7/P8)
  became moot when the redesign (100ee0ea) replaced CreateProjectSidebar with a template picker.
- Leftover: a stale comment at `frontend/src/components/molecules/TemplateSelectForm/TemplateSelectForm.vue:189`
  still mentions the removed `.wizard-step-fill` class — trivial, tracked in task 021.
