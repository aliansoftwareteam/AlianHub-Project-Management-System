...
### 2026-09-10 — closed
- Done. Browser verification is covered by the AR-53 functional sweep (5813a68c).
- The two unticked items — the run-history drawer for `GET /api/v2/automations/:id/runs` and the
  "test on a real task" dry-run — were declared out of scope in task.md; both are recorded as
  follow-ups in task 021.
