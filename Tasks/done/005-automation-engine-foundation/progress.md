...
### 2026-09-10 — closed
- Done: all 12 checklist items verified live against beta (64f4f507).
- The "Ghost User" author on automation comments (`Modules/Automations/engine/tools.js:115`
  writes `userId` `automation:<ruleId>`) is now task 020. The ADR 002 amendment for
  Agenda-on-global was never written; tracked in task 021.
