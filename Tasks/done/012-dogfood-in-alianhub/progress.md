...
- [x] Use it for real; log friction below
- [x] Raise blocking gaps as their own tasks

## Last step
Closed 2026-09-10. The log through 2026-09-04 (AR-24, AR-41–44, AR-48, AR-50–53) and `functional-gaps.md` satisfy the last two checklist items; verified read-only against the local database.
...
### 2026-09-10 — closed
- Done. The log through 2026-09-04 (AR-24, AR-41–44, AR-48, AR-50–53) plus `functional-gaps.md`
  satisfy the last two checklist items; verified read-only against the local database.
- The "AlianHub Redesign" project still holds sample/fixture rows worth trashing — tracked in
  task 021.
