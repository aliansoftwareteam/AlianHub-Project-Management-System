...
### 2026-09-10 — closed
- Done. All six areas landed in PR #525. The one visible gap, the legacy-styled `ImportCsvModal`,
  closed in PR #527 (a4d95921), which opens the four-step CSV wizard from the project List and
  deletes the legacy modal.
