...
## Last step
Closed 2026-09-10. Wave 1 integrated; wave 2 landed as PR #525 (`feat/redesign-project-views` is an ancestor of beta). Product gaps the redesigned screens exposed live in `Tasks/done/012-dogfood-in-alianhub/functional-gaps.md`; visual QA against the mocks stays with the owner.
...
### 2026-09-10 — closed
- Done. Wave 2 landed as PR #525 (`feat/redesign-project-views` is an ancestor of beta); the
  "Last step" that still said wave 2 was not started is corrected above.
- Product gaps stay in `Tasks/done/012-dogfood-in-alianhub/functional-gaps.md`.
