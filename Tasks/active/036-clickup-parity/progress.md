...
- 2026-09-24: all four slices merged: #949 (build 418), #952 (420), #953 (421) and #951 (422), plus #950 (419) for recent visits and private sprints found while building slice 1. #951's first no-provider gate replaced every AI screen; it was narrowed so a missing provider only adds a notice and AI off replaces only the model-driven screens. Follow-ups 125–127 in task 034.
