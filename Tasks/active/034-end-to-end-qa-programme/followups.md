...
| 103 | Delete the `prReview.js` code skill once `SKILL_EXTERNAL_READS` defaults on and the `pr.summary` data seed replaces it. **Decided** 2026-09-23: removed together with `PR_SUMMARY_AS_DATA`; `SKILL_EXTERNAL_READS` alone runs the data version. **Closed** by this PR. | #819 |
