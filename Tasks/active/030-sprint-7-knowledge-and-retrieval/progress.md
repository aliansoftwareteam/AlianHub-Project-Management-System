...
## Last step
Slices 0, 1, 2, 3, 5, 6 and 9 merged (builds 210–229). Slice 4 (#783) in review; slice 8 in progress; then 10 (knowledge console), 7 (Atlas adapter) and 11 (retire the regex path, after the owner's question set).
