...
## State of `beta` (8a34b97a, `14.36.0-beta.403`)

- **Overnight 2026-09-23/24: builds 303–403 (#834–#934)**, listed in `docs/BETA-LOG.md`.
...
1. **In flight at session end:** row 122 (third-sweep interface items).
2. **Owner questions:** row 113 (`--ink-3` contrast); row 120 (required company phone, state and city on Settings → General); row 121 (agent spend visible to members); row 119 (decision 8 re-check once real downloads are logged); review existing Google sign-in links (details in the owner's private notes).
...
4. **Open follow-ups:** 57, 77, 79, 83, 84, 89, 94, 96, 98, 101, 113, 114, 119–123 in `Tasks/active/034-end-to-end-qa-programme/followups.md`.
