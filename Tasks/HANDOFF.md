...
4. **Remaining follow-ups:** 14, 26, 55–64 and 65–83 in `Tasks/active/034-end-to-end-qa-programme/followups.md`. Item 72 (an integration-suite order dependency) will bite any full local run that happens to order `invited-owner` before `instance-fixes`.
