...
1. **Nothing in flight at session end.** Builds 404–406: the report filter fix (#936), this log (#935) and the third-sweep interface items (#937).
...
4. **Open follow-ups:** 57, 77, 79, 83, 84, 89, 94, 96, 98, 101, 113, 114, 119–121, 123, 124 in `Tasks/active/034-end-to-end-qa-programme/followups.md`.
